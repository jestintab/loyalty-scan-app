...
void main() {
  ...
  test('a staff member with one business lands signed in on that business',
      () async {
  ...
  test('an account linked to no business says so, and stores nothing',
      () async {
    final container = containerWith();
  ...
  test('restore with nothing stored is signed out, with no error shown',
      () async {
    final container = containerWith();
